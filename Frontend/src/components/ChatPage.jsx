...
//   const [loading, setLoading] = useState(true);//CHECKS WHETEHER DATA IS GETING FETCHED OR NOT
...
//   //FETCHES THE MESSAGES OF THE PARTICULAR CHATID
//   useEffect(() => {
...
//         <ChatArea toggleSidebar={toggleSidebar} messages={messages} chatId={chatId} />
//         </div>
//       </div>)}
